...
## Step 3: Check for any releases between v0.2.4 and current
...
If there are any releases AFTER v0.2.4 that aren't listed above, reconstruct their notes from:
```bash
git log --oneline v0.2.4..HEAD
```
And add entries for those too.
