...
### Verification Log
✅ RTX 3090 Llama 3 8B Q4 performance — verified (Verified Reference Data)
✅ RX 7900 XT Llama 3 8B Q4 performance — verified (Verified Reference Data)
✅ RTX 3080 12GB price — verified (Verified Reference Data)
✅ RX 7900 XT price — verified (Verified Reference Data)
✅ NVIDIA cards tok/s per GB/s — verified (Verified Reference Data)
✅ AMD ROCm cards tok/s per GB/s — verified (Verified Reference Data)
✅ ROCm 7.2.0 RDNA4 support — verified (Verified Reference Data)
✅ RTX 3090 VRAM capacity — verified (Verified Reference Data)
✅ RX 7900 XT VRAM capacity — verified (Verified Reference Data)
...
### Missing Data
The article could have included a brief section on system RAM requirements and how it impacts offloading. It also doesn't mention the RTX 4060 Ti 16GB, which is a relevant card given its VRAM capacity. Benchmarks for more models on both platforms would also be beneficial.
