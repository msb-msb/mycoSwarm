...
For $1,040 (typical used price), the **RTX 3090** is the undisputed champion. It has 24GB of VRAM and 936 GB/s of bandwidth. This combination allows you to run 30B parameter models at Q4 quantization or even squeeze in 70B models at Q2.
*   **Performance:** Benchmarks show it hitting **112 tok/s** on Llama 3 8B Q4 and **39.9 tok/s** on Gemma 3 27B.
...
This is the most critical recommendation for developers on a budget. At roughly **$305 used**, it offers 12GB VRAM and **912 GB/s** bandwidth.
...
For under $275 used, the **RTX 3060** is the baseline for local development.
...
AMD cards like the **RX 7900 XT** (20GB, $600) offer competitive specs on paper. However, the ROI is lower due to software friction.
