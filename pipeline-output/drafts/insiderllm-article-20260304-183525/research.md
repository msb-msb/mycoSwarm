...
| Fact | Source URL |
|------|------------|
| NVIDIA's CUDA platform powers over 90% of AI frameworks; ROCm is AMD's open-source alternative | [aimultiple.com](https://research.aimultiple.com/cuda-vs-rocm/) |
| **CUDA Gap Score** (28.7–99.1 range) quantifies NVIDIA's software advantage: real-world throughput exceeds hardware specs by 30-99% | [aimultiple.com](https://research.aimultiple.com/cuda-vs-rocm/) |
| ROCm 7.2.0 adds RDNA4 support (RX 9060 XT LP, RX 9070 series) and RDNA3 RX 7700 GPUs | [rocm.docs.amd.com](https://rocm.docs.amd.com/en/latest/about/release-notes.html) |
| ROCm 7.11.0 is technology preview; production use should use ROCm 7.2.0 | [rocm.docs.amd.com](https://rocm.docs.amd.com/en/latest/reference/gpu-arch-specs.html) |
| AMD's MI300X has 1,307 TFLOPS vs NVIDIA H100's 990 TFLOPS (32% theoretical advantage), but NVIDIA leads by 38.9% at 4× GPU and 46% at 8× GPU | [aimultiple.com](https://research.aimultiple.com/cuda-vs-rocm/) |
| ROCm 6.4.4 adds PyTorch support on Windows for RX 7000/9000 series GPUs (preview release, Sep 2025) | [wccftech.com](https://wccftech.com/amd-rocm-6-4-4-pytorch-support-windows-radeon-9000-radeon-7000-gpus-ryzen-ai-apus/) |
| RX 7800 XT was removed from ROCm supported GPUs list on Windows (GitHub discussion, Oct 2023) | [github.com/ROCm/ROCm/discussions/2599](https://github.com/ROCm/ROCm/discussions/2599) |
| CUDA Gap Score increases with scale: +29.4% at 2× GPU, +71.0% at 4× GPU, +78.1% at 8× GPU | [aimultiple.com](https://research.aimultiple.com/cuda-vs-rocm/) |
| At 512 concurrent users, NVIDIA H100 delivers +67.0% more throughput than MI300X | [aimultiple.com](https://research.aimultiple.com/cuda-vs-rocm/) |
| AMD RX 7900 XTX outperforms RTX 4090 in DeepSeek R1 inference benchmarks | [techbloat.com](https://www.techbloat.com/amd-radeon-rx-7900-xtx-outperforms-nvidia-geforce-rtx-4090-in-deepseek-ai-inference-benchmarks-how-to-run-r1-on-your-local-amd-system.html) |
| AMD ROCm cards achieve ~0.06 tok/s per GB/s bandwidth vs NVIDIA's ~0.13 tok/s per GB/s | [insiderllm canonical database](https://insiderllm.com/hardware/) |
...
| DDR4-3200 | 25.6 GB/s | ~37× slower per layer | [insiderllm canonical](https://insiderll