...
New data from March 2026 confirms specific price points and performance benchmarks for the secondary market, highlighting that **VRAM capacity** is often more critical than raw bandwidth for budget builds, though bandwidth remains the primary predictor of speed for models fitting entirely in VRAM.
...
## New Data Section: Gap-Fill Findings (March 2026)
*The following data points were retrieved from the InsiderLLM canonical hardware database and eBay sold auctions to fill specific gaps in pricing, performance metrics, and architectural details.*

### A. Verified Used Pricing & Specific Model Performance
*   **RTX 3060 (12GB):** Confirmed as the "entry-level workhorse."
    *   *Price:* $170–$380 (Typical ~$275).
    *   *Benchmarks:* Llama 3 8B Q4: **51 tok/s**. Llama 2 13B Q4: **35 tok/s**.
*   **RTX 3080 (12GB):** Identified as a "sleeper pick" for value.
    *   *Price:* $230–$380 (Typical ~$305).
    *   *Performance:* Llama 3 8B Q4: **107 tok/s** (2.5x speed of 3060).
*   **RTX 3090 (24GB):** Confirmed "Budget Local AI King."
    *   *Price:* $950–$1125 (Typical ~$1040).
    *   *Performance:* Llama 3 70B Q4: **16 tok/s**. Mistral 7B Q6: **85 tok/s**.
*   **RTX 4060 / 4060 Ti (8GB):** Explicitly advised to **avoid** for local AI due to 128-bit bus bottleneck despite newer architecture.
    *   *Price:* $230–$310 (4060), $240–$300 (4060 Ti 8GB).
    *   *Benchmarks:* Llama 3 8B Q4: **38 tok/s** (significantly slower than 3060).
*   **RTX 4060 Ti (16GB):** Viable for capacity but slow.
    *   *Price:* $380–$480.
    *   *Benchmarks:* Llama 3 8B Q4: **48 tok/s**.

### B. AMD ROCm Specifics & Pricing
*   **RX 7600 (8GB):** Low bandwidth, limited AI utility despite being budget-friendly ($170–$225).
*   **RX 7800 XT (16GB):** Best AMD value for bandwidth/VRAM ratio.
    *   *Price:* $380–$550.
    *   *Benchmarks:* Llama 3 8B Q4: **39 tok/s** (slower than NVIDIA equivalents due to ROCm kernel overhead).
*   **RX 7900 XT (20GB):** Best current AMD option for large models.
    *   *Price:* $500–$700.
    *   *Benchmarks:* Llama 2 7B Q4: **116 tok/s** (sustained ~97 tok/s).

### C. VRAM & Model Capacity Rules of Thumb
*   **Capacity Mapping:**
    *   **6GB:** Max 7B Q4 (tight).
    *   **8GB:** Comfortable 8B Q4, 14B Q2 possible.
...
### D. Performance Physics & CPU Offloading
*   **Bandwidth vs. Speed:** For models fitting entirely in VRAM, bandwidth is the primary predictor. Double bandwidth ≈ Double tok/s for memory-bound inference.
    *   NVIDIA avg: ~0.13 tok/s per GB/s (Llama 3 8B Q4).
    *   AMD ROCm avg: ~0.06 tok/s per GB/s (due to less optimized kernels).
*   **CPU Offloading Penalty:** DDR4-3200 (25.6 GB/s) is ~37x slower than GDDR6X (936 GB/s) for offloaded layers.
    *   **RAM Costs:** DDR4 16GB (~$50-80 used) vs DDR5 32GB (~$200-300 used).

### E. Emerging Hardware (Preliminary/Unconfirmed)
*   **RTX 50 Series:** RTX 5060 (8GB rumored), 5070 (12GB, 672 GB/s bandwidth confirmed MSRP $549).
*   **RX 9000 Series:** RX 9070/XT (16GB, RDNA 4) – ROCm support status for RDNA 4 remains unknown as of March 2026.
...
*   **New:** *InsiderLLM Canonical Hardware Database* (Verified March 2026): eBay sold auction prices, specific benchmark tokens/sec, VRAM capacity models, and architecture-specific performance multipliers.